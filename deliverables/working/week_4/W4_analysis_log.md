...
| A29 | Executive deck build and visual QA | Structured outline, design contract, final evidence register | Reproducible 18-slide build; render inventory; geometry, overflow, overlap, placeholder, whitespace, design, and visual-review gates; contact-sheet and selected full-slide inspection | 18/18 slides rendered; all automated warning/error counts zero; manual review recorded | Visual polish does not validate client evidence or approve execution | `decks/northstar-final/build/qa/` and final PPTX/PDF |
