...
| F1 | Feasibility | What can be delivered without replacing the three ERPs? | Staged connectivity and data standards are more feasible than immediate platform replacement | Interface inventory, architecture, ERP retirement, data owners | Capability/dependency map | Wave sequencing | High | Untested |
...
| E2 | Execution | What sequence minimizes payment disruption? | Pilot-first sequencing outside Q4 peak is required | Peak calendar, pilot entities, rollback, SLAs, dependencies | 30/60/90-day plan and stage gates | Mobilization approval | High | Supported |
