...
- **Definitions:** Immediate account candidate = dormant, legacy-purpose, and zero supplied payments. Stale positive value = positive closing USD on accounts reported at least two calendar days late, summarized daily. Manual/cross-border shares use only the supplied 7,600-record payment set; population completeness is unproven. Capacity sensitivities apply 15% and 20% to estimated annual manual process hours.
