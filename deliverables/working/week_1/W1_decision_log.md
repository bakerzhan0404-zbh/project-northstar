...
| DEC-02 | 2026-08-02 | Use date-equal-to-report-date as a preliminary same-day proxy, not as proof of start-of-day visibility | Analyst | No timestamps are supplied | Obtain timestamped reporting logs | Replace proxy when evidence arrives | Daniel Wu / Sarah Coleman | Week 2 |
...
| Decision required | Options | Preliminary recommendation | Evidence needed | Owner | Required by |
|---|---|---|---|---|---|
