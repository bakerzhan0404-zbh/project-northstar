...
Open `http://127.0.0.1:8000/docs/dashboard/`. The dashboard supports metric search, governed date/currency/region/entity/bank filters, decision-focused liquidity and payment comparisons, and a Metric guide with definitions, formulas, and sources. It is a local Week 1–2 diagnostic snapshot, not a live operational system. See `docs/dashboard/README.md` for the interaction, evidence, refresh, and test details.
